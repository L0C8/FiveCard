...
draw_triangle(_arrow_up_x1, _arrow_up_y1, _arrow_up_x2, _arrow_up_y2, _arrow_up_x3, _arrow_up_y3, false);
draw_triangle(_arrow_down_x1, _arrow_down_y1, _arrow_down_x2, _arrow_down_y2, _arrow_down_x3, _arrow_down_y3, false);

draw_rectangle(_textfield_left, _textfield_top, _textfield_right, _textfield_bottom, false);

var _bet_string = string(_value);
